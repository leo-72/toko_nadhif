                            ...
                            <div class="product-details">
                                ...
                                <div class="pd-desc"> 
                                    ...
                                    <?= form_open('buy') ?>
                                        ...
                                        <div class="form-group">
                                            <?= form_label('Masukkan diskon', 'diskon') ?>
                                            <?= form_input($diskon) ?>
                                        </div>
                                        <p id="diskon_message"></p>
                                        <div class="form-group">
...
<script>
    ...
    $("#diskon").on('change', function(){
      ...
      console.log(diskon_val)
			$.ajax({
				...
				dataType : 'json',
				success : function(data){
					console.log(data[0].tanggal_berakhir);
          const api_date = data[0].tanggal_berakhir
          const dateNow = `${new Date().getFullYear()}-${new Date().getMonth()+1}-${new Date().getDate()}`
          if(api_date > dateNow){
            $("#diskon_message").text('Masih Berlaku')
            // console.log(true)
          }else{
            $("#diskon_message").text('Diskon tidak berlaku')
            // console.log(false)
          }
				},
			});
    ...
    // $("#diskon").on('change', function(){
		// 	var diskon = $('option:selected', this).attr('etd');
		// 	diskon = $(this).val();
    //   const splitDiskon = diskon.split('.')[1]
		// });

		$("#jumlah").on("change", function(){
			jumlah_pembelian = $("#jumlah").val();
      if(diskon){
        var total_harga = (jumlah_pembelian*harga)+ongkir-parseInt(diskon);        
      }
			var total_harga = (jumlah_pembelian*harga)+ongkir;
			$("#total_harga").val(total_harga);
		});
